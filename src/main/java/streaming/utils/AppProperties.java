...
public class AppProperties {
    ...
    public final static int KAFKA_CACHE_MAX_BYTES_BUFFERING_CONFIG=Integer.parseInt(props.getProperty("kafka.cache.max.bytes.buffering.config"));
    ...
    public final static String STREAMING_STATE_WRITING_TIME_STORE=props.getProperty("streaming.state.writing.time.store");

    public final static String STREAMING_STATE_REFERENCE_TIME_STORE=props.getProperty("streaming.state.reference.time.store");

    public final static String STREAMING_STATE_LAST_KEYSTROKES_STORE=props.getProperty("streaming.state.last.keystroke.store");
    ...
    public final static String STREAMING_STATE_TOTAL_PAGE_STAY_STORE=props.getProperty("streaming.state.total.page.stay.store");
